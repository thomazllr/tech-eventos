        ...
        <div class="form-wrapper">
            <form class="form" method="post" action="../src/controller/UsuarioController.php">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="usuario-senha-confirmacao" name="confirmacao-senha" class="form-input" required placeholder="Confirme sua senha" minlength="4" maxlength="20">
                </div>
